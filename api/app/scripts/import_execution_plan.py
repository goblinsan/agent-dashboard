...
from app.models import Milestone, Phase, Project, Task
    ...
    "milestones": [
        {
            ...
            "phases": [
                ...
                },
                {
                    ...
                    "tasks": [
                        {
                            "title": "/v1/projects/:id/status computed with remaining hours",
                            "status": "done",
                        },
                        {
                            "title": "/v1/projects/:id/next-action returns top 3 placeholders",
                            "status": "done",
                        },
                    ],
                },
                {
                    ...
                    "tasks": [
                        ...
                        {
                            "title": "Daily status summary generated by API and shown on dashboard",
                            "status": "done",
                        },
                    ],
                },
            ...
            "phases": [
                {
                    ...
                    "tasks": [
                        {"title": "Personas registry + limits (read-only UI)", "status": "not_started"},
